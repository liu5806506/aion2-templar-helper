...
class BotController:
    ...
    def __init__(self, input_ctrl, combat_logic, config):
        ...
        Args:
            ...
            combat_logic (LogicController): 战斗逻辑
            config (dict): 配置字典
        """
    ...
    def exit(self):
        ...
        try:
            ...
            if hasattr(self.combat_logic, 'close'):
    ...
    def get_state(self):
        ...
        Returns:
            str: 当前状态
        """
        if hasattr(self.combat_logic, 'state_machine'):
            return self.combat_logic.state_machine.state
        else:
            return 'unknown'
